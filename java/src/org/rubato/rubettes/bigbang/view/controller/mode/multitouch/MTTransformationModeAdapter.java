...
import org.rubato.rubettes.bigbang.view.controller.score.multitouch.MTObjectTransformationAdapter;
...
public class MTTransformationModeAdapter extends MTDisplayModeAdapter {
	...
	public MTTransformationModeAdapter(ViewController controller, BigBangScene scene) {
		super(controller);
		this.addProcessorAndListener(new ZoomProcessor(scene.getMTApplication()), new MTObjectTransformationAdapter(controller));
	}
