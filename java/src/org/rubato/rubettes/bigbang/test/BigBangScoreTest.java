...
public class BigBangScoreTest extends TestCase {
	...
	protected void setUp() {
		...
		this.score = new BigBangComposition(this.objects.SOUND_SCORE_FORM);;
	}
	...
	public void testAddNodesAndFindPaths() {
		//addNodes
		this.score.setOrAddComposition(this.objects.multiLevelMacroScore);
	...
	public void testRemoveNotes() throws RubatoException {
		this.score.setOrAddComposition(this.objects.flatMacroScore);
