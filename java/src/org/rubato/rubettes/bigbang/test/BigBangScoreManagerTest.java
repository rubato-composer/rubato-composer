...
public class BigBangScoreManagerTest extends TestCase {
	...
	public void testMapNodesFlat() {
		...
		SelectedObjectsPathss notePaths = this.makeNotePaths(new int[]{0}, new int[]{2});
		SelectedObjectsPathss newPaths = this.scoreManager.mapObjects(notePaths, translation, false, false);
	...
	public void testMapRationalTriples() throws RubatoException {
		...
		SelectedObjectsPathss newPaths = this.scoreManager.mapObjects(new SelectedObjectsPathss(triplesPath, null), translation, false, false);
	...
	public void testMapRealTriple() throws RubatoException {
		...
		SelectedObjectsPathss newPaths = this.scoreManager.mapObjects(new SelectedObjectsPathss(emptyPath, null), translation, false, false);
	...
	public void testMapNodesMultiLevel() throws RubatoException {
		...
		SelectedObjectsPathss nodePaths = this.makeNotePaths(new int[]{1}, new int[]{0,1,0});
		SelectedObjectsPathss newPaths = this.scoreManager.mapObjects(nodePaths, translation, false, false);
		TestCase.assertEquals(new DenotatorPath(this.objects.SOUND_SCORE_FORM, new int[]{0}), newPaths.get(0).get(0));
		...
		newPaths = this.scoreManager.mapObjects(nodePaths, translation, false, false);
		TestCase.assertEquals(new DenotatorPath(this.objects.SOUND_SCORE_FORM, new int[]{0}), newPaths.get(0).get(0));
		TestCase.assertEquals(new DenotatorPath(this.objects.SOUND_SCORE_FORM, new int[]{1,1,0}), newPaths.get(0).get(1));
	...
	public void testMapModulators() throws RubatoException {
		...
		SelectedObjectsPathss nodePaths = this.makeNotePaths(new int[]{0,0,6,0,6,0});
		SelectedObjectsPathss newPaths = this.scoreManager.mapObjects(nodePaths, translation, false, false);
	...
	public void testShapeNotes() throws RubatoException {
		...
		TransformationProperties properties = new TransformationProperties(new SelectedObjectsPathss(paths, null), Arrays.asList(this.nodePaths), false, false, false);
	...
	public void testShapeRationalTriples() throws RubatoException {
		...
		TransformationProperties properties = new TransformationProperties(new SelectedObjectsPathss(paths, null), Arrays.asList(this.rationalTriplesPaths), false, false, false);
		TreeMap<Double,Double> shapingLocations = new TreeMap<Double,Double>();
	...
	public void testShapeRealTriples() throws RubatoException {
		...
		TransformationProperties properties = new TransformationProperties(new SelectedObjectsPathss(paths, null), Arrays.asList(this.realTriplesPaths), false, false, false);
		TreeMap<Double,Double> shapingLocations = new TreeMap<Double,Double>();
	...
	private SelectedObjectsPathss makeNotePaths(int[]... intNotePaths) {
		...
		return new SelectedObjectsPathss(Arrays.asList(notePaths), null);
	}
